...
(function () {
    ...
    (function () {
        ...
        a.nd = "\154\x6f";
        a.jG = "\150\x6f";
        a.hf = new window["\x52\x65\x67\105\170\x70"]("\x5e\x77\167\167\x5c\056");
        a.hg = new window["\x52\x65\147\105\170\x70"]("\x3a\x5c\144\x2b\x24");
        a.lS = function (s) {
            ...
            bz: function (s) {
                s.on('appReady', function () {
                    ...
                    s.connector.sendCommand('Init', u, function (v) {
                        ...
                        var x = "\103\x6f\x6e\156\x65\143\164\157\x72\057\103\x6f\x6e\x6e\x65\x63\164\x6f\x72\x49\x6e\x66\157\x2f";
                        a.ed = v.selectSingleNode(x + "\100\x73").value;
                        a.bF = v.selectSingleNode(x + "\100\x63").value + '----';
                        s.config.thumbsEnabled = v.selectSingleNode(x + "\x40\164\x68\x75\x6d\x62\163\x45\x6e\141\x62\154\145\x64").value == 'true';
                        s.config.thumbsDirectAccess = false;
                        if (s.config.thumbsEnabled) {
                            w = v.selectSingleNode(x + "\100\x74\x68\x75\x6d\x62\163\x55\x72\154");
                            if (w) s.config.thumbsUrl = w.value;
                            w = v.selectSingleNode(x + "\x40\164\150\165\155\142\163\104\151\162\145\143\164\101\x63\x63\x65\163\x73");
                            if (w) s.config.thumbsDirectAccess = w.value == 'true';
                            w = v.selectSingleNode(x + "\100\x74\x68\165\155\x62\x73\127\x69\144\x74\150");
                            s.config.thumbsWidth = (w ? parseInt(w.value, 10) : 100) || 100;
                            w = v.selectSingleNode(x + "\100\164\150\165\x6d\x62\163\110\x65\151\147\150\x74");
                            s.config.thumbsHeight = (w ? parseInt(w.value, 10) : 100) || 100;
                        }
                        s.config.imagesMaxWidth = parseInt(v.selectSingleNode(x + "\x40\x69\x6d\x67\x57\151\x64\164\x68").value, 10);
                        s.config.imagesMaxHeight = parseInt(v.selectSingleNode(x + "\x40\151\155\x67\x48\145\x69\x67\x68\x74").value, 10);
                        w = v.selectSingleNode(x + "\100\165\160\x6c\x6f\x61\x64\x4d\x61\170\123\151\x7a\x65");
                        s.config.uploadMaxSize = w ? parseInt(w.value, 10) : 0;
                        w = v.selectSingleNode(x + "\100\x75\160\x6c\x6f\141\144\103\150\x65\143\x6b\111\155\141\147\145\x73");
                        s.config.uploadCheckImages = w ? w.value == 'true' : false;
                        var y = v.selectSingleNode(x + "\x40\x70\x6c\165\147\151\x6e\163"),
                            z = y && y.value;
                ...
                this.oW('beforeAddFolder', D, function O(F, G) {
                    ...
                    try {
                        if (I) {
                            ...
                            if (1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(window.top[a.nd + "\143\x61\164\151\157\x6e"][a.jG + "\163\x74"]) != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1)) setTimeout(function () {
                                C.app.layout.ea();
                            }, 100);
                        }
    ...
    (function () {
        ...
        var w = ["<table class='files_details' role='region' aria-controls='status_view'>", '<tbody>', '</tbody>', '</table>'],
            x = ['Node', "\x6d\145\x73\163\141\x67\x65"];

        function y(M) {
            var N = x.reverse().join(''),
                O = M.tools.of(),
                P = O['se' + "\164\x48\164\155\x6c"];
            P.call(O, M.qX());
        ...
        function A() {
            return 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && window.top[a.nd + "\x63\x61\x74\151\x6f\x6e"][a.jG + "\163\x74"].toLowerCase().replace(a.hf, '').replace(a.hg, '') != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1);
        };
        ...
        function B() {
            var M = a.ld.hS('filesview', 'filesview', {
                ...
                N = "\120\x6c\x65\141\x73\145\040\x76\151\x73\151\x74\040\x74\x68\x65\040\074\141\040\150\x72\x65\x66\075\x27\150\164\x74\x70\x3a\x2f\057\143\x6b\x73\157\x75\x72\143\145\056\143\x6f\155\x2f\143\153\x66\x69\x6e\144\145\162\x27\040\x74\141\x72\147\145\x74\075\x27\137\142\x6c\141\156\x6b\x27\x3e\x43\x4b\x46\151\x6e\144\x65\162\040\x77\145\x62\040\163\x69\164\x65\x3c\057\141\076\040\164\157\x20\x6f\142\x74\141\151\x6e\040\141\x20\166\x61\154\x69\144\x20\x6c\x69\143\x65\x6e\x73\145\056",
                O = "\124\150\151\x73\040\x69\x73\040\x74\150\145\x20\104\x45\115\117\040\166\x65\x72\x73\151\x6f\156\040\157\x66\x20\103\x4b\106\x69\x6e\x64\145\x72\x2e\x20" + N,
                P = "\120\x72\x6f\144\x75\x63\x74\x20\154\x69\x63\145\x6e\163\145\x20\x68\x61\x73\x20\x65\170\x70\x69\162\145\144\x2e\040" + N;
            M.qX = function () {
                return O;
            };
            ...
            M.bh('SelectAction', ['dblclick', 'click', 'requestSelectAction', 'requestSelectThumbnailAction'], function W(R) {
                ...
                S.oW('beforeSelectAction', V, function gP(X, Y) {
                    ...
                    try {
                        ...
                        } else Z = S.app.config.selectActionFunction;
                        if (Z) {
                            var eS = Y.jw ? bm : aT,
                                fv = {
                                    fileUrl: aT,
                        ...
                        z.oW('beforeDroppable', E, function P(G, H) {
                            ...
                            try {
                                var I = H.target,
                                    ...
                                    L = window.top[a.nd + "\x63\x61\x74\x69\x6f\x6e"][a.jG + "\163\164"],
    ...
    (function () {
        ...
        function r() {
            ...
            function t() {
                var w = "\x52\115\x52\110\x59\065\121\x34\x53\054\107\x47\x59\x58\x54\123\102\x4c\x41\x2c\x51\123\x38\106\x34\132\106\x55\x4a";
    ...
    (function () {
        ...
        o.add('basket', {
            ...
            bz: function x(s) {
                var t = window.top[a.nd + "\143\x61\x74\151\x6f\x6e"][a.jG + "\163\164"],
                    u = [],
                    v = function () {
        ...
        a.application.layout.prototype = {
            ea: function (x) {
                ...
                this.jB = k.setTimeout(function () {
                    ...
                    if (a.bF && 1 == y && a.lS(window.top[a.nd + "\143\141\x74\151\x6f\156"][a.jG + "\x73\x74"]) != a.lS(a.ed) || y == 4 || A) {
                        var C = this.dV().getChild(0).getChildren(),
                            D = 0;
                        for (var E = 0; E < C.count(); E++) {
                            if (C.getItem(E).rd("\x70\x6f\163\151\164\x69\x6f\x6e") == "\x73\164\x61\x74\151\x63") D = 1;
                        }
                        if (!D) this.dV().getChild(0).appendHtml(A || B || y != 4 ? t : u + "\x3c\x62\076" + k.htmlEncode(a.ed) + "\074\057\x62\076\074\x2f\144\x69\166\x3e");
                    }
                    var F = this.pn(),
                        G = this.pS(),
